...
public class IniciarSesion extends javax.swing.JFrame {
    ...
    private static ManejadorArchivo fileManager;
    
    public IniciarSesion(ManejadorArchivo fileManager){
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try{
                    ...
                    fileManager.recuperaUsuarios(URLDecoder.decode(ManejadorArchivo.class.getResource("forbiddenmemories").getFile(),"UTF-8"));
                    fileManager.recuperarUsuarioActual(URLDecoder.decode(IniciarSesion.class.getResource("forbiddenmemories2").getFile(),"UTF-8"));
